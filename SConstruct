...
env = Environment(
        CPPPATH = ['.', 'src', 'thirdparty/boost_1_57_0/', './thirdparty/include', 'src/utils'] ,
        LIBS = ['sofa-pbrpc', 'protobuf', 'snappy', 'gflags', 'tcmalloc', 'unwind', '-lins_sdk', 'glog', 'pthread', 'z', 'rt', 'boost_filesystem'],
