...
_sym_db.RegisterEnumDescriptor(_PODSTAGE)
...
_sym_db.RegisterEnumDescriptor(_MEMISOLATIONTYPE)
...
_sym_db.RegisterEnumDescriptor(_CPUISOLATIONTYPE)
...
_RESOURCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='read_bytes_ps', full_name='baidu.galaxy.Resource.read_bytes_ps', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='write_bytes_ps', full_name='baidu.galaxy.Resource.write_bytes_ps', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='syscr_ps', full_name='baidu.galaxy.Resource.syscr_ps', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='syscw_ps', full_name='baidu.galaxy.Resource.syscw_ps', index=8,
...
_PODSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='priority', full_name='baidu.galaxy.PodStatus.priority', index=9,
...
DESCRIPTOR.enum_types_by_name['PodStage'] = _PODSTAGE
...
DESCRIPTOR.enum_types_by_name['MemIsolationType'] = _MEMISOLATIONTYPE
DESCRIPTOR.enum_types_by_name['CpuIsolationType'] = _CPUISOLATIONTYPE
...
PodDescriptor = _reflection.GeneratedProtocolMessageType('PodDescriptor', (_message.Message,), dict(
  DESCRIPTOR = _PODDESCRIPTOR,
  __module__ = 'galaxy_pb2'
  # @@protoc_insertion_point(class_scope:baidu.galaxy.PodDescriptor)
  ))
_sym_db.RegisterMessage(PodDescriptor)
