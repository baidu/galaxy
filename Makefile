...
#COMAKE UUID
COMAKE_MD5=2aa6c2cbbf7ed0f43075d857ce8b7198  COMAKE
...
clean:ccpclean
	...
	rm -rf common/galaxy_client_logging.o
...
galaxy_client:common/galaxy_client_logging.o \
  src/client/galaxy_client_galaxy_client.o \
  ./libgalaxy.a
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40mgalaxy_client[0m']"
	$(CXX) common/galaxy_client_logging.o \
  src/client/galaxy_client_galaxy_client.o -Xlinker "-(" ./libgalaxy.a ../../../public/sofa-pbrpc/lib/libsofa_pbrpc.a \
  ../../../third-64/libcurl/lib/libcurl.a \
  ../../../third-64/protobuf/lib/libprotobuf-lite.a \
  ../../../third-64/protobuf/lib/libprotobuf.a \
  ../../../third-64/protobuf/lib/libprotoc.a \
...
common/galaxy_client_logging.o:common/logging.cc \
  common/logging.h
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40mcommon/galaxy_client_logging.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) $(CPPFLAGS) $(CXXFLAGS)  -o common/galaxy_client_logging.o common/logging.cc
