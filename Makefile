...
#COMAKE UUID
COMAKE_MD5=75a75ed45d974062333bd74f898d91b9  COMAKE


.PHONY:all
all:comake2_makefile_check agent master libgalaxy.a galaxy_client curl_downloader_test downloader_mgr_test partitioner copy_sh 
...
clean:ccpclean
	...
	rm -rf src/mapreduce/shuffle/partitioner_partitioner.o
...
partitioner:copy_sh \
  src/mapreduce/shuffle/partitioner_partitioner.o
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40mpartitioner[0m']"
	$(CXX) src/mapreduce/shuffle/partitioner_partitioner.o -Xlinker "-("  ../../../public/sofa-pbrpc/lib/libsofa_pbrpc.a \
  ../../../third-64/libcurl/lib/libcurl.a \
  ../../../third-64/protobuf/lib/libprotobuf-lite.a \
  ../../../third-64/protobuf/lib/libprotobuf.a \
  ../../../third-64/protobuf/lib/libprotoc.a \
  ...
  -lidn \
  -lssl \
  -lldap -Xlinker "-)" -o partitioner
	mkdir -p ./output/bin
	cp -f --link partitioner ./output/bin

copy_sh:
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40mcopy_sh[0m']"
	mkdir -p output/bin && cp src/mapreduce/shuffle/easy_shuffle.sh output/bin
...
src/mapreduce/shuffle/partitioner_partitioner.o:src/mapreduce/shuffle/partitioner.cc \
  src/mapreduce/shuffle/partitioner.h
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40msrc/mapreduce/shuffle/partitioner_partitioner.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) $(CPPFLAGS) $(CXXFLAGS)  -o src/mapreduce/shuffle/partitioner_partitioner.o src/mapreduce/shuffle/partitioner.cc
