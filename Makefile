...
DEP_INCPATH=-I../../../public/sofa-pbrpc \
  ...
  -I../../../third-64/sqlite \
  -I../../../third-64/sqlite/include \
  -I../../../third-64/sqlite/output \
  -I../../../third-64/sqlite/output/include
...
#COMAKE UUID
COMAKE_MD5=e929665e7d9aeb41805fb8336bd2e046  COMAKE


.PHONY:all
all:comake2_makefile_check agent master libgalaxy.a galaxy_client curl_downloader_test downloader_mgr_test resource_collector_test scheduler_test 
...
clean:ccpclean
	...
	rm -rf scheduler_test
	rm -rf ./output/bin/scheduler_test
	...
	rm -rf src/master/master_scheduler.o
	...
	rm -rf src/master/scheduler_test_scheduler.o
	rm -rf test/scheduler_test_scheduler_test.o
...
agent:src/agent_flags.o \
  ...
  src/agent/agent_resource_collector.o \
  src/agent/agent_resource_manager.o \
  src/agent/agent_resource_collector_engine.o -Xlinker "-("  ../../../public/sofa-pbrpc/libsofa-pbrpc.a \
  ...
  ../../../third-64/sqlite/lib/libsqlite3.a -lpthread \
  -lcrypto \
  -lrt \
  -lidn \
  -lssl \
...
master:src/master_flags.o \
  ...
  src/master/master_master_impl.o \
  src/master/master_master_main.o \
  src/master/master_scheduler.o -Xlinker "-("  ../../../public/sofa-pbrpc/libsofa-pbrpc.a \
  ../../../third-64/boost/lib/libboost_atomic.a \
  ../../../third-64/boost/lib/libboost_chrono.a \
  ../../../third-64/boost/lib/libboost_container.a \
  ../../../third-64/boost/lib/libboost_context.a \
...
curl_downloader_test:src/agent/curl_downloader_test_curl_downloader.o \
  ...
  test/curl_downloader_test_curl_downloader_test.o \
  common/curl_downloader_test_logging.o -Xlinker "-("  ../../../public/sofa-pbrpc/libsofa-pbrpc.a \
  ../../../third-64/boost/lib/libboost_atomic.a \
  ../../../third-64/boost/lib/libboost_chrono.a \
  ../../../third-64/boost/lib/libboost_container.a \
  ../../../third-64/boost/lib/libboost_context.a \
...
resource_collector_test:src/agent/resource_collector_test_resource_collector.o \
  ...
  test/resource_collector_test_resource_collector_test.o \
  common/resource_collector_test_logging.o \
  src/agent/resource_collector_test_resource_collector_engine.o -Xlinker "-("  ../../../public/sofa-pbrpc/libsofa-pbrpc.a \
  ../../../third-64/boost/lib/libboost_atomic.a \
  ../../../third-64/boost/lib/libboost_chrono.a \
  ../../../third-64/boost/lib/libboost_container.a \
  ../../../third-64/boost/lib/libboost_context.a \
...
scheduler_test:src/master/scheduler_test_scheduler.o \
  test/scheduler_test_scheduler_test.o
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40mscheduler_test[0m']"
	$(CXX) src/master/scheduler_test_scheduler.o \
  test/scheduler_test_scheduler_test.o -Xlinker "-("  ../../../public/sofa-pbrpc/libsofa-pbrpc.a \
  ../../../third-64/boost/lib/libboost_atomic.a \
  ../../../third-64/boost/lib/libboost_chrono.a \
  ../../../third-64/boost/lib/libboost_container.a \
  ../../../third-64/boost/lib/libboost_context.a \
  ...
  -lidn \
  -lssl \
  -lldap -Xlinker "-)" -o scheduler_test
	mkdir -p ./output/bin
	cp -f --link scheduler_test ./output/bin
...
src/master/master_scheduler.o:src/master/scheduler.cc \
  src/master/scheduler.h \
  common/mutex.h \
  common/timer.h \
  common/logging.h
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40msrc/master/master_scheduler.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) $(CPPFLAGS) $(CXXFLAGS)  -o src/master/master_scheduler.o src/master/scheduler.cc
...
src/master/scheduler_test_scheduler.o:src/master/scheduler.cc \
  src/master/scheduler.h \
  common/mutex.h \
  common/timer.h \
  common/logging.h
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40msrc/master/scheduler_test_scheduler.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) $(CPPFLAGS) $(CXXFLAGS)  -o src/master/scheduler_test_scheduler.o src/master/scheduler.cc

test/scheduler_test_scheduler_test.o:test/scheduler_test.cc \
  src/master/scheduler.h \
  common/mutex.h \
  common/timer.h
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40mtest/scheduler_test_scheduler_test.o[0m']"
	$(CXX) -c $(INCPATH) $(DEP_INCPATH) $(CPPFLAGS) $(CXXFLAGS)  -o test/scheduler_test_scheduler_test.o test/scheduler_test.cc
