...
public:
    static ResourceManager* ConnectResourceManager();
    ...
    virtual bool CreateContainerGroup(const CreateContainerGroupRequest& request, CreateContainerGroupResponse* response) = 0;
    virtual bool RemoveContainerGroup(const RemoveContainerGroupRequest& request, RemoveContainerGroupResponse* response) = 0;
    virtual bool UpdateContainerGroup(const UpdateContainerGroupRequest& request, UpdateContainerGroupResponse* response) = 0;
    virtual bool ListContainerGroups(const ListContainerGroupsRequest& request, ListContainerGroupsResponse* response) = 0;
    virtual bool ShowContainerGroup(const ShowContainerGroupRequest& request, ShowContainerGroupResponse* response) = 0;
    ...
    virtual bool OfflineAgent(const OfflineAgentRequest& request, OfflineAgentResponse* response) = 0;
    ...
    virtual bool ListAgentsByTag(const ListAgentsByTagRequest& request, ListAgentsByTagResponse* response) = 0;
    virtual bool GetTagsByAgent(const GetTagsByAgentRequest& request, GetTagsByAgentResponse* response) = 0;
    virtual bool AddAgentToPool(const AddAgentToPoolRequest& request, AddAgentToPoolResponse* response) = 0;
    virtual bool RemoveAgentFromPool(const RemoveAgentFromPoolRequest& request, RemoveAgentFromPoolResponse* response) = 0;
    virtual bool ListAgentsByPool(const ListAgentsByPoolRequest& request, ListAgentsByPoolResponse* response) = 0;
    virtual bool GetPoolByAgent(const GetPoolByAgentRequest& request, GetPoolByAgentResponse* response) = 0;
